...
> CSS gradient generator and collection

[![npm version](https://badge.fury.io/js/gradient-gen.svg)](https://www.npmjs.com/package/gradient-gen)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)

## Installation

```bash
npm install gradient-gen
```

## Quick Start

```javascript
const { gen } = require('gradient-gen');
...
```javascript
const { gen, batch } = require('gradient-gen');
